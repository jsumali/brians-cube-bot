...
if __name__ == '__main__':
    event_metadata = [
        ...
        ('2019-08-31-draft1', 'Phil', 'UB Artifacts', 'data/2019-08-31_Cube_Winner_Phil_-_UB_Artifacts.txt'),
        ('2019-08-31-draft2', 'Phil', 'UW Artifacts', 'data/2019-08-31_Cube_Winner_Phil_UW_Artifacts.txt'),
        ...
        ('2020-02-01-draft1', 'Brian', 'Mono Green', 'data/2020-02-01_Cube_Winner_1_Brian_-_Mono_Green.txt'),
        ('2020-02-01-draft2', 'Jeff', 'Mono Red', 'data/2020-02-01_Cube_Winner_2_Jeff_-_Mono_Red.txt')
    ]
